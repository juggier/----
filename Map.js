...
function Map(map, window) {
        ...
        function CreateHouses() {
            ...
            for (let i = 0; i < low_heights.length; i++) {
                ...
                for (let j = 0; j < scope.houses.length; j++) {
                    ...
                    const neighbor_dist = coffset_distance(low_heights[i][0], low_heights[i][1], scope.houses[j][0], scope.houses[j][1]);
                ...
                for (let j = 0; j < scope.points.length; j++) {
                    ...
                    const dist = coffset_distance(low_heights[i][0], low_heights[i][1], scope.points[j][0], scope.points[j][1]);
        ...
        function CreateTrees() {
            ...
            for (let i = 0; i < middle_heights.length; i++) {
                ...
                for (let j = 0; j < scope.points.length; j++) {
                    ...
                    const dist = coffset_distance(middle_heights[i][0], middle_heights[i][1], scope.points[j][0], scope.points[j][1]);
                ...
                for (let j = 0; j < scope.jungles.length; j++) {
                    ...
                    const neighbor_dist = coffset_distance(middle_heights[i][0], middle_heights[i][1], scope.jungles[j][0], scope.jungles[j][1]);
                ...
                for (let j = 0; j < scope.houses.length; j++) {
                    ...
                    const dist = coffset_distance(middle_heights[i][0], middle_heights[i][1], scope.houses[j][0], scope.houses[j][1]);
        ...
        function CreateCamera(canvas) {
            ...
            let camera = new THREE.OrthographicCamera(left, right, top, bottom, -1, 50);
